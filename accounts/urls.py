...
from .views \
    ...
    ReservationDetail, ReservationDelete
...
urlpatterns = [
    ...
    path('mypage/<int:pk>/reservation_detail/', ReservationDetail.as_view(), name='reservation_detail'),
    path('mypage/<int:pk>/reservation_delete/', ReservationDelete.as_view(), name='reservation_delete'),
